...
public class SinkFilter extends FilterFramework
{
	public void run()
    {
		...
		*************************************************************************************/
		...
		long measurement;
		double altitude_measurement = 0.0;		// This is the word used to store temperature measurements
		...
		while (true)
		{
			try
			{
				...
				****************************************************************************/
				...
				// If ID == 2, we are refering to the altitude ID
				if (id == 2)
				{
					altitude_measurement = Double.longBitsToDouble(measurement); //convert and save the measurement bits in a double variable

				} // if

				// If ID == 4, we are refering to the temperature ID. We now have all the measurements we want to output
				// to the file, so we can output it right away
				if ( id == 4 )
				{
